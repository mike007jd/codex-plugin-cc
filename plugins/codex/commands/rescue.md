...
- If neither flag is present, default to background. Codex rescue runs can take many minutes and a foreground subagent leaves the Claude Code UI stuck on "Initializing…" until Codex finishes.
